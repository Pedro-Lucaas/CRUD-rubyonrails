...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { assembly_method: @hardware.assembly_method, product_id: @hardware.product_id } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { assembly_method: @hardware.assembly_method, product_id: @hardware.product_id } }
