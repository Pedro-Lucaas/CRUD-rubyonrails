...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { category: @software.category, language: @software.language, product_id: @software.product_id, version: @software.version } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { category: @software.category, language: @software.language, product_id: @software.product_id, version: @software.version } }
